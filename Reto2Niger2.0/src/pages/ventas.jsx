...
const VentasPage = () => {
    ...
    const getCantidadDisponible = (tipoMaceta) => {
        ...
        const nombreBuscado = nombreMap[tipoMaceta.toLowerCase()];
            ...
            {adding && (
                <div style={{
                    ...
                    >
                        ...
                        <option value="small">Small (Disponible: {getCantidadDisponible('small')} unidades)</option>
                        <option value="medium">Medium (Disponible: {getCantidadDisponible('medium')} unidades)</option>
                        <option value="big">Big (Disponible: {getCantidadDisponible('big')} unidades)</option>
                    </select>
